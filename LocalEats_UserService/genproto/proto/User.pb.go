...
var file_User_proto_rawDesc = []byte{
	...
	0x74, 0x75, 0x73, 0x32, 0xc1, 0x02, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68, 0x53, 0x65, 0x72, 0x76,
	...
	0x2e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x42, 0x10, 0x5a, 0x0e, 0x67, 0x65, 0x6e, 0x70, 0x72,
...
var file_User_proto_depIdxs = []int32{
	...
	10, // 7: auth.AuthService.Register:output_type -> auth.Status
	4,  // 8: auth.AuthService.Login:output_type -> auth.Token
	10, // 9: auth.AuthService.ResetPassword:output_type -> auth.Status
	10, // 10: auth.AuthService.Logout:output_type -> auth.Status
	8,  // 11: auth.AuthService.GetProfile:output_type -> auth.GetProfileResponse
	10, // 12: auth.AuthService.UpdateProfile:output_type -> auth.Status
