...
func (u *UserRepo) SearchKitchens(filter *pb.SearchKitchensRequest) (*pb.SearchKitchensResponse, error) {
	...
	var args []interface{}
	filterStr := "WHERE deleted_at IS NULL" 
	...
	query := "SELECT id, owner_id, name, address, phone_number, cuisine_type, description, rating, total_orders FROM kitchens " + filterStr + limit + offset
