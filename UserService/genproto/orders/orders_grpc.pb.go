...
type OrderServiceClient interface {
	...
	UpdateReview(ctx context.Context, in *Review, opts ...grpc.CallOption) (*Status, error)
...
func (c *orderServiceClient) CreateReview(ctx context.Context, in *Review, opts ...grpc.CallOption) (*Review, error) {
	out := new(Review)
...
func (c *orderServiceClient) UpdateReview(ctx context.Context, in *Review, opts ...grpc.CallOption) (*Status, error) {
	out := new(Status)
...
type OrderServiceServer interface {
	...
	UpdateReview(context.Context, *Review) (*Status, error)
...
func (UnimplementedOrderServiceServer) CreateReview(context.Context, *Review) (*Review, error) {
...
func (UnimplementedOrderServiceServer) UpdateReview(context.Context, *Review) (*Status, error) {
...
func _OrderService_CreateReview_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).CreateReview(ctx, req.(*Review))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _OrderService_UpdateReview_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).UpdateReview(ctx, req.(*Review))
	}
	return interceptor(ctx, in, info, handler)
}
